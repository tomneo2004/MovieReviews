...
import { IDiscoverMoviesData, IMovieGenreListData } from "../../utils/api/model/apiModelTypes";
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    const data = await fetchDiscoverData(`${apiDiscoverRoute}?genreId=${genreId}&page=${page}`);
