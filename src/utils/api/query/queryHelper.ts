 ...
 */
function buildQuery(relQueryString:string, movieAPIService:string, apiVersion:string){
    const query = urljoin(
        movieAPIService,
        apiVersion,
        relQueryString,
...
function addQueryParams(
    queryString:string, params:IParams=defaultParams){
 ...
 */
export function buildAPIQuery(relQueryString:string,
    apiService:string, apiVersion:string, apiKey:string, params:IParams=defaultParams){
