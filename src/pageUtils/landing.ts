...
import { RFCMotionOptions, RFCTextGroup } from "../components/concrete/RFCarousel/RFCarousel";
import { springTransition } from "../framer/Transition";
import { IMovieData, INowPlayingData, ITopRatedMoviesData } from "../utils/api/model/apiModelTypes";
import { getNowPlayingMoviesQuery, getPouplarMoviesQuery, getTopRatedMovieQuery, getTrendingQuery } from "../utils/api/query/apiQueryBuilder";
