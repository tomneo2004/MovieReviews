...
export const FloatingValue = () => {
  return <CircularRating value={56.64} />;
};

export const Postive = () => {
  return <CircularRating value={70} />;
};

export const Average = () => {
  return <CircularRating value={60} />;
};

export const Negative = () => {
  return <CircularRating value={5} />;
};

export const TransparentBG = () => {
  return <CircularRating value={5} bgcolor="rgba(0,0,0,0.5)" />;
};

export const MaskOpacity = () => {
  return <CircularRating value={5} maskOpacity={0.7} />;
};

export const HideValue = () => {
  return <CircularRating value={64} hideValue />;
};

export const ValueVariant = () => {
  return <CircularRating value={64} valueVariant="h5" />;
};

export const ValueFontWeight = () => {
  return <CircularRating value={64} valueVariant="h5" valueFontWeight={700} />;
};
...
export const ValueOnly = () => {
  return <CircularRating value={64} />;
};

export const ValueWithPercentage = () => {
  return <CircularRating value={64} valueEndAdornment={<Box>%</Box>} />;
};
...
export const AnimateValueAndAdornemnt = () => {
  ...
  const negativeAdo = (
    <ThumbDownIcon style={{ width: "15px", height: "15px" }} />
  );
  const averageAdo = (
    <ThumbsUpDownIcon style={{ width: "15px", height: "15px" }} />
  );
