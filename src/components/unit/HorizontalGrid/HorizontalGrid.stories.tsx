...
export const Default = ()=>{
    ...
    return (
        <HorizontalGrid itemCount={items.length} itemWidth={60} width='100%' height='35px'>
        {({index})=>{
...
export const ItemWidth = ()=>{
    ...
    return (
        <HorizontalGrid itemCount={images.length} itemWidth={400} width='100%' height={400*1.5} overflow='hidden'>
        {({index, measure})=>{
            return (
                <img
                src={images[index]}
...
export const ItemHeight = ()=>{
    ...
    return (
        <HorizontalGrid itemCount={images.length} itemWidth={400} itemHeight={400*1.3} width='100%' height={400*1.3} overflow='hidden'>
        {({index, measure})=>{
            return (
