...
import RevealFadeMotion, {
  RFMSize,
} from "../../../framer/RevealFadeMotion/RevealFadeMotion";
              ...
              return (
                ...
                >
                  <Typography
                    variant={variant}
                    component="div"
                    noWrap={option.axis !== "y"}
                  >
                    <Box pl={option.indent}>{value.text}</Box>
                  </Typography>
                </RevealFadeMotion>
              );
            })}
