 ...
 * @param props
 */
const ScaleFadeMotion:React.FC<ScaleFadeMotionProps> = (props: ScaleFadeMotionProps) => {
  const {
  ...
  const vars: Variants = {
    init: { opacity: initOpacity, transform: `scale(${initScale}, ${initScale})` },
    enter: { opacity: enterOpacity, transform: `scale(${enterScale}, ${enterScale})`, transition: enterTransition},
    exit: {opacity: exitOpacity, transform: `scale(${exitScale}, ${exitScale})`, transition: exitTransition},
  };
