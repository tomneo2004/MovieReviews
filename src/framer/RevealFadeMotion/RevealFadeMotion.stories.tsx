...
export const Multiple = () => {
  ...
  const motionTexts = [
    ...
    >
      <Typography variant="h4" component="div">
        <Box fontSize="3rem">This trip</Box>
      </Typography>
    </RevealFadeMotion>,
    <RevealFadeMotion
      key="2"
    ...
    >
      <Typography variant="h4" component="div">
        <Box fontSize="3rem">few days ago</Box>
      </Typography>
    </RevealFadeMotion>,
    <RevealFadeMotion
      key="3"
    ...
    >
      <Typography variant="h4" component="div">
        <Box fontSize="3rem">is so awesome</Box>
      </Typography>
    </RevealFadeMotion>,
  ];
  return (
...
export const Stopable = () => {
  ...
  for (let i = 0; i < total; i++) {
    motionTexts.push(
      ...
      >
        <Typography variant="h4" component="div" noWrap>
          <Box fontSize="3rem">A text used to test</Box>
        </Typography>
      </RevealFadeMotion>
    );
  }
